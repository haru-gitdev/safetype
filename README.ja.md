...
- :keyboard: **グローバルホットキー** - どのアプリからでも `Cmd+Ctrl+Space` で即起動（カスタマイズ可能）
...
3. **macOSに「アプリが壊れている」と表示された場合:**
   - アプリケーションフォルダの `Safetype.app` を右クリック（またはControlを押しながらクリック）
   - メニューから **「開く」** を選択
   - 確認ダイアログで **「開く」** をクリック
